...
export const V7_TECH_CALCULATORS: Calculator[] = [
  {
    ...
    category: 'tech',
    description: 'Calculate subnetting information based on IP range and custom CIDR notation.',
    seoTitle: 'IP Subnet Mask & CIDR Calculator | Calculatoora',
    seoDescription: 'Find IP subnets, usable hosts, broadcast addresses, and wildcard masks using CIDR notations.',
    inputs: [
